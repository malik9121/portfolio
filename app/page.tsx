...
import { Menu, X, Mail, Linkedin, Github, Instagram, Youtube, Download, ChevronDown, Send } from 'lucide-react';
      ...
      <section className="pt-32 pb-20 px-6 max-w-7xl mx-auto relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <svg className="absolute w-full h-full" viewBox="0 0 1200 800">
            ...
            {/* Animated connecting lines (neural pathways) */}
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            ...
            >
              ...
              <motion.div
                className="absolute -bottom-4 right-6 px-4 py-2 bg-cyan-500/20 border border-cyan-400/50 rounded-lg backdrop-blur-sm"
                animate={{ y: [0, -5, 0] }}
                transition={{ duration: 2, repeat: Infinity }}
              >
                <p className="text-sm font-semibold text-cyan-300">Web Developer</p>
              </motion.div>
              <motion.div
                className="absolute top-6 left-6 px-4 py-2 bg-blue-500/20 border border-blue-400/50 rounded-lg backdrop-blur-sm"
                animate={{ y: [0, 5, 0] }}
                transition={{ duration: 2.5, repeat: Infinity }}
              >
                <p className="text-sm font-semibold text-blue-300">AI Engineer</p>
              </motion.div>
              <motion.div
                className="absolute top-1/2 right-6 px-4 py-2 bg-teal-500/20 border border-teal-400/50 rounded-lg backdrop-blur-sm"
                animate={{ y: [0, -5, 0] }}
                transition={{ duration: 3, repeat: Infinity, delay: 0.5 }}
              >
                <p className="text-sm font-semibold text-teal-300">Content Creator</p>
              </motion.div>
                  <motion.div
                    className="absolute bottom-6 left-6 px-4 py-2 bg-blue-500/20 border border-blue-400/50 rounded-lg backdrop-blur-sm"
                    animate={{ y: [0, -4, 0] }}
                    transition={{ duration: 3.2, repeat: Infinity, delay: 0.6 }}
                  >
                    <p className="text-sm font-semibold text-blue-300">AI Assistant Architect</p>
                  </motion.div>
